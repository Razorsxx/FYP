...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public ChessPiece pickupPieces;
        ...
        private void Awake()
        {
            ...
            board = GameObject.Find("GameBoard").GetComponent<ChessBoard>();
            if (!_camera)
            {
                _camera = Camera.main;
                return;
        ...
        //function to allow the player to interact with objects
        ...
        public bool SwapIsValid(int i, int offset, int colCheck)
        {
